...
export function CodeBlock({ lang, code }: { lang: string; code: string }) {
  ...
  // Optimization: useShallow prevents CodeBlock re-renders when other workspaceStore state changes
  const { openWorkspace, runCode } = useWorkspaceStore(useShallow(s => ({ openWorkspace: s.openWorkspace, runCode: s.runCode })));
