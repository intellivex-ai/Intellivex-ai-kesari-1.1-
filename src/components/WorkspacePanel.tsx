...
function TerminalOutput() {
  const { sandboxOutputs, clearOutputs, isRunning } = useWorkspaceStore(
    useShallow(s => ({ sandboxOutputs: s.sandboxOutputs, clearOutputs: s.clearOutputs, isRunning: s.isRunning }))
  )
...
function FileExplorer() {
  const { files, activeFile, setActiveFile } = useWorkspaceStore(
    useShallow(s => ({ files: s.files, activeFile: s.activeFile, setActiveFile: s.setActiveFile }))
  )
