...
function TerminalOutput() {
  // Optimization: use useShallow with specific properties to avoid full component re-renders
...
export function WorkspacePanel() {
  // Optimization: use useShallow to prevent unnecessary re-renders when internal workspace store objects update
  const {
